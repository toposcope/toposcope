...
The packaged image is pinned to `ghcr.io/toposcope/toposcope:0.4.4` and should not be replaced with `:latest`.
...
`0.3.14` is the first public pin. Pin `0.4.3` to roll back application code from `0.4.4`.

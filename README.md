...
Current release: `0.4.2` · [MIT Expat license](LICENSE)

## Quick start

The packaged install is the recommended path for operators. Download these four files from the [v0.4.2 release](https://github.com/toposcope/toposcope/releases/tag/v0.4.2) into one directory:
...
The deployment pins `ghcr.io/toposcope/toposcope:0.4.2`; it never uses `:latest`. Anonymous image pulls need no registry login.

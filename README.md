...
Current release: `0.4.6` · [MIT Expat license](LICENSE)

## Quick start

The packaged install is the recommended path for operators. Download these four files from the [v0.4.6 release](https://github.com/toposcope/toposcope/releases/tag/v0.4.6) into one directory:
...
The deployment pins `ghcr.io/toposcope/toposcope:0.4.6`; it never uses `:latest`. Anonymous image pulls need no registry login.
